...
local function CreateOptionsPanel()
    ...
    local buffSettingsActions = {
        ...
        roguePoisons = {
            ...
            -- TODO: dispatches via BR.Options.* instead of a forward-declared local to avoid
            -- tipping CreateOptionsPanel past the Lua 5.1 60-upvalue limit. Remove the indirection
            -- once CreateOptionsPanel is split into smaller builders.
            onClick = function()
                BR.Options.ShowRoguePoisonModal()
            end,
        },
        petPassive = {
...
BR.Options = {
    ...
    Show = ShowOptions,
    Hide = HideOptions,
    -- TODO: exported here (rather than forward-declared like other Show*Modal functions) to
    -- keep CreateOptionsPanel under the Lua 5.1 60-upvalue limit. Revert once that function
    -- is refactored into smaller builders.
    ShowRoguePoisonModal = ShowRoguePoisonModal,
}
